...
class App extends React.Component {
	constructor(props) {
		...
		this.handleFloatSubMenuClick = () => {
			if (this.state.pageSidebarMinify) {
				...
				const left =
					...
					'px';
				const bottom =
					windowHeight - targetTop > targetHeight ? 'auto' : '0';
				const arrowTop =
		...
		this.state = {
			...
			handleSetPageSidebarTransparent: this
			...
			handleSetPageContentInverseMode: this
