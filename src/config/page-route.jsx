...
//import CurrentExecution from '../pages/dashboard/currentExecution.js';
...
import CurrentExecution from '../containers/CurrentExecution';
...
const routes = [
	...
	{
		path: '/dashboard/current_execution',
		title: 'Current Execution',
		component: () => <CurrentExecution />
	},
	{
