const Menu = [
	{ path: '/overview', icon: 'fa fa-th', title: 'Overview' },
	{ path: '/dashboard/v2', icon: 'fa fa-th', title: 'Current Execution' },
	{
		path: '/defetsmanagement',
		icon: 'fa fa-calendar',
		title: 'Defets Management'
	},
	{ path: '/testlab', icon: 'fa fa-map', title: 'Test Lab' },
	{
		path: '/performancestats',
		icon: 'fa fa-image',
		title: 'Performance Stats'
	},
	{ path: '/reports', icon: 'fa fa-calendar', title: 'Reports' },
	{ path: '/history', icon: 'fa fa-map', title: 'History' },
	{ path: '/settings', icon: 'fa fa-image', title: 'Settings' },
	{ path: '/logout', icon: 'fa fa-image', title: 'Logout' }
	// {
	// 	path: '/dashboard',
	// 	icon: 'fa fa-th',
	// 	title: 'Dashboard',
	...
	// { path: '/reports', icon: 'fa fa-calendar', title: 'Reports' },
	// { path: '/history', icon: 'fa fa-map', title: 'History' },
	// { path: '/settings', icon: 'fa fa-image', title: 'Sett		ings' }
	// {
	// 	path: '/email',
	// 	icon: 'fa fa-hdd',
	// 	title: 'Email',
